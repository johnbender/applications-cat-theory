...
jQuery.fn.extend({
	...
	removeAttrSimple: function( name ) {
		var length = this.length, elem, propName, isBool;
	...
	removeAttrWithCall: function( value ) {
		var length = this.length, elem;
		var propName, attrNames, name, l, isBool,	i;
	...
	removeAttrSimpleWithCall: function( name ) {
		var length = this.length, elem;
...
jQuery.extend({
	removeAttrSimple: function( elem, name ) {
		var propName, isBool;
