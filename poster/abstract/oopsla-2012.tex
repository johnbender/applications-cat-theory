...
With the categories in place satifying the functor laws in mapping from \textbf{Html} to \textbf{Jqry} provides the concrete set of JavaScript functions necessary to proceed with optimizing jQuery method chains. Identity is trivial but preserving composition is the central insight.
